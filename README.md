...
- The base model (on which the one in this repo was built) performed best using 'he_normal' (truncated normal) distribution compared to normal and [he_uniform](https://www.tensorflow.org/api_docs/python/tf/keras/initializers/HeUniform) distributions to initialize the kernels.
